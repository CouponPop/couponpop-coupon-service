...
import com.couponpop.couponservice.domain.coupon.service.CouponIssueConcurrencyTestSupport;
...
@Slf4j
@Disabled
class LettuceLockCouponIssueConcurrencyTest extends CouponIssueConcurrencyTestSupport {

    @Autowired
    private LettuceLockCouponIssueService couponIssueFacade;
